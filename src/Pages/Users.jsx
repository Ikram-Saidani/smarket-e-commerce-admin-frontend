...
function Users() {
  ...
  //   }, [token]);
  return (
    <div className="mainPage userssPage">
      <UserNavbar />
      {<div className="users">{/* get users that have not made any order 
      update user's role by admin
      **delete user(if he is assigned too group remove him from the group)
      get users that their birthday is in this month
      get coordinators that are not assigned to any group
      get ambassadors that are not assigned to any group
      notify ambassador eligibility
